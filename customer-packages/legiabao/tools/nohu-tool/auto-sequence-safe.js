...
class AutoSequenceSafe {
    ...
    async saveAccountInfoOnce(profileData, firstSiteName) {
        try {
            ...
            console.log('    💾 Saving shared account info...');

            // Create accounts folder: accounts/username/
...
`;
            ...
            // Save as account.txt and account.json (shared for all sites)
            const accountFile = path.join(userAccountDir, 'account.txt');
            const accountJsonFile = path.join(userAccountDir, 'account.json');
