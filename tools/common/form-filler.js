...
class CommonFormFiller {
    ...
    /**
     * Fill text input field với slow typing
     * @param {Page} page - Puppeteer page
     * @param {string} selector - CSS selector của input
     * @param {string} value - Giá trị cần fill
     * @param {object} options - { delay, beforeFocus, afterField }
     */
    async fillTextField(page, selector, value, options = {}) {
        ...
        try {
            ...
            // Type slowly
            await page.type(selector, value, { delay: opts.delay || opts.betweenChars });
            ...
            console.warn(`⚠️ Failed to fill ${selector}:`, error.message);
